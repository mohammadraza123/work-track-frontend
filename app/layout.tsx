...
export const metadata: Metadata = {
  ...
  description: "Work-Track helps clients manage projects, track work progress, and stay organized anywhere. Fully works offline.",
  ...
  icons: {
    icon: [
      { url: "/icons/worktrack-192.svg", sizes: "192x192", type: "image/svg+xml" },
      { url: "/icons/worktrack-512.svg", sizes: "512x512", type: "image/svg+xml" },
    ],
    apple: [
      { url: "/icons/worktrack-192.svg" },
    ],
  },
  keywords: ["work tracking", "project management", "client management", "offline app"],
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta property="og:description" content="Work-Track helps clients manage projects, track work progress, and stay organized anywhere. Fully works offline." />
