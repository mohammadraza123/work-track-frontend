...
export default function LeavePage() {
  ...
  // Sort leaves - newest requests show on top
  ...
  return (
    <>
      <div className="min-h-screen bg-[#1e2035] relative overflow-hidden">
        ...
        {/* Ambient orbs */}
        <motion.div
          className="fixed w-80 h-80 rounded-full bg-indigo-500/8 blur-3xl pointer-events-none"
          animate={{
            x: [0, 60, -30, 0],
            y: [0, -50, 70, 0],
            scale: [1, 1.2, 0.9, 1],
        ...
        />
        <motion.div
          className="fixed w-60 h-60 rounded-full bg-purple-500/8 blur-3xl pointer-events-none"
