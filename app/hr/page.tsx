...
function HRLogin({ onLogin }: { onLogin: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-[#1e2035] flex items-center justify-center p-4 relative overflow-hidden">
      {/* Ambient orbs */}
      <motion.div
        className="absolute w-80 h-80 rounded-full bg-indigo-500/10 blur-3xl pointer-events-none"
        animate={{
          x: [0, 60, -30, 0],
          y: [0, -50, 70, 0],
          scale: [1, 1.2, 0.9, 1],
  ...
  return (
    ...
    >
      <div className="bg-[#32364f] border border-white/8 rounded-2xl p-4 relative overflow-hidden">
        ...
        <div
          className="flex items-center gap-2 text-white/40 text-xs mb-4"
        ...
        <div className="flex gap-2" style={{ transform: "translateZ(12px)" }}>
          ...
          >
            <AnimatePresence mode="wait">
              <motion.span
                key={updating === leave._id ? "loading" : "label"}
...
function HRDashboard({ onLogout }: { onLogout: () => void }) {
  ...
  return (
    <div className="min-h-screen bg-[#1e2035] relative overflow-hidden">
      ...
      {/* Orbs */}
      <motion.div
        className="fixed w-96 h-96 rounded-full bg-indigo-500/8 blur-3xl pointer-events-none"
        animate={{
          x: [0, 80, -40, 0],
          y: [0, -60, 80, 0],
          scale: [1, 1.2, 0.9, 1],
      ...
      />
      <motion.div
        className="fixed w-72 h-72 rounded-full bg-purple-500/8 blur-3xl pointer-events-none"
      ...
      <div className="relative z-10 max-w-xl mx-auto px-4 pt-8 pb-12">
        ...
        >
          ...
          <motion.button
            ...
            className="flex items-center gap-1.5 text-white hover:text-white text-sm transition"
            initial={{ opacity: 0, x: 20 }}
            animate={{ opacity: 1, x: 0 }}
